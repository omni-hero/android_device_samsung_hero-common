...
#define LOG_TAG "hero-power-service"
// #define LOG_NDEBUG 0
...
int main() {
	...
	ALOGI("Hero Power HAL Service is starting...");
    ...
    ALOGI("Hero Power HAL Service is ready!");
    joinRpcThreadpool();

shutdown:
    ALOGE("Hero Power HAL Service is shutting down...");
    return 1;
}
